...
export default function ThreeJSComponent() {
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            loadModel(
                "https://raw.githubusercontent.com/devhnlee/point-cloud-viewer/main/assets/street_PC.ply",
                new THREE.Vector3(0, 0, 0),
                ""
            )
            loadModel(
                "https://raw.githubusercontent.com/devhnlee/point-cloud-viewer/main/assets/spatial wellness_PC.ply",
                new THREE.Vector3(0, 0, 0),
                "spatialwellness"
            )
            loadModel(
                "https://raw.githubusercontent.com/devhnlee/point-cloud-viewer/main/assets/osbm_PC.ply",
                new THREE.Vector3(0, 0, 0),
                "osbm"
            )
            loadModel(
                "https://raw.githubusercontent.com/devhnlee/point-cloud-viewer/main/assets/easy%20pair_PC.ply",
                new THREE.Vector3(0, 0, 0),
                "easypair"
            )
            loadModel(
                "https://raw.githubusercontent.com/devhnlee/point-cloud-viewer/main/assets/living archive_UPDATE_PC.ply",
                new THREE.Vector3(0, 0, 0),
                "livingarchive"
            )
